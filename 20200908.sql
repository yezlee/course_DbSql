...
SELECT  MONTHS_BETWEEN(TRUNC(SYSDATE,'DD'),hiredate ) , TRUNC(SYSDATE,'DD'),  -- 이건 trunc를 쓰면 날짜 이후로 다 00:00:00이됨 고용날짜랑 
        TRUNC(SYSDATE,'D'),TRUNC(SYSDATE,'mm'),TRUNC(SYSDATE,'y')
FROM emp;
